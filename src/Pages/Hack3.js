                ...
                <div className="flex flex-wrap items-center md:flex-row flex-col-reverse">
                  <div className="md:w-2/3 w-full pb-6 md:pb-0 md:pr-6 flex-col md:block flex items-center justify-center md:pt-0 pt-4">
                    <div>
                      ...
                      >
                        Hackoverflow 4.0 offline Hackathon , Chandigarh
                        University
                      </h1>
                    </div>
                    {/* <button
              ...
              <div className="md:w-1/2 lg:w-2/3 w-full xl:pr-20 md:pr-6">
                <div className="py-2 text-color">
                  ...
                  <h2 className="text-lg lg:text-3xl lg:leading-7 md:leading-10 f-f-r py-4 md:py-8">
                    This post is just another example of the fact- No one i
                    perfect but if you believe in yourself and work hard,
                    Wonders can happen. Recently our team got selected in top 50
                    in a 36hr national level hackathon organised by Hackoverflow
                    Society, Chandigarh University named HACK THE FEST. The
                    competition being very intense, we spent sleepless nights
                    building, brainstorming and finally ended up making a full
                    stack MERN based project called CampusHub, entirely
                    dedicated to the campuses nationwide. After multiple rounds
                    of assessment and judgement, we were totally exhausted out
                    of energy. Finally took a night of rest and then came the
                    final day morning. Unexpectedly, just 30 mins before the
                    final round, we were informed to have made into top 10. We
                    just gave our best in the final presentation and left rest
                    to the God. We got to see some of coolest projects built by
                    the brightest minds out there. And finally it was a dream
                    come true when it was announced-"The 2nd runner up award
                    goes to team TechnoMaits". Can never express that feeling.
                  </h2>
              ...
              <div className="md:w-1/2 lg:w-2/3 w-full lg:pl-20 md:pl-10 sm:pl-0 pl-0">
                <div className="py-2 text-color">
                  ...
                  <h2 className="text-lg lg:text-3xl leading-7 md:leading-10 f-f-r py-8">
                    Basically , our idea of hackathon should solve a real world
                    problem , it should be unique and it should be almost fully
                    functional.
                  </h2>
                  <div className="flex items-center cursor-pointer pb-4 md:pb-0">
